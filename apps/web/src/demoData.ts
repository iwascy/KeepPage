...
export function createDemoWorkspace(): DemoWorkspace {
  ...
  const tags: Tag[] = [
    ...
    { id: "tag_ai", name: "ai" },
    { id: "tag_backend", name: "backend" },
    { id: "tag_incident", name: "incident" },
  ];
  ...
  const folders: Folder[] = sortFolders([
    ...
    { id: "folder_eng_api", name: "API", path: "Engineering/API", parentId: "folder_eng" },
    ...
    { id: "folder_inbox", name: "Inbox", path: "Inbox", parentId: null },
    { id: "folder_ops", name: "Operations", path: "Operations", parentId: null },
    { id: "folder_ops_incidents", name: "Incidents", path: "Operations/Incidents", parentId: "folder_ops" },
  ]);
  ...
  const qualityReaderOnly = createQuality(84, "high", {
    reasons: [
      {
        code: "reader-only",
        message: "当前仅保留了阅读视图产物，原始 archive.html 已被裁剪出在线预览路径。",
        impact: 9,
      },
    ],
    liveSignals: {
  ...
  const qualityIncident = createQuality(58, "low", {
    reasons: [
      {
        code: "text-loss",
        message: "事故时间线中的长段落保留不完整，文本损失明显。",
        impact: 22,
      },
      {
        code: "screenshot-missing",
        message: "采集时未生成截图，列表卡片只能退回到文字摘要。",
        impact: 7,
      },
      {
        code: "third-party-timeout",
        message: "第三方监控脚本加载超时，导致部分嵌入图表缺失。",
        impact: 11,
      },
    ],
    liveSignals: {
  ...
  const bookmarks: Bookmark[] = [
    {
      id: "bm_ai_005",
      sourceUrl: "https://platform.openai.com/docs/guides/text?api-mode=responses",
      canonicalUrl: "https://platform.openai.com/docs/guides/text",
      ...
      versionCount: 2,
      latestQuality: createQuality(95, "high", {
        liveSignals: {
          textLength: 22500,
          imageCount: 12,
          iframeCount: 0,
      ...
      createdAt: "2026-03-19T08:48:00.000Z",
      updatedAt: "2026-03-20T09:18:00.000Z",
    },
    {
      id: "bm_guide_001",
    ...
    {
      id: "bm_reader_006",
      sourceUrl: "https://design-system.service.gov.uk/components/accordion/",
      ...
      versionCount: 1,
      latestQuality: qualityReaderOnly,
    ...
    {
      id: "bm_incident_008",
      sourceUrl: "https://status.example.net/incidents/cdn-timeout-2026-03-18",
  ...
  const versionsByBookmarkId: Record<string, BookmarkDetailVersion[]> = {
    bm_ai_005: [
      {
        id: "ver_ai_002",
        bookmarkId: "bm_ai_005",
        versionNo: 2,
        htmlObjectKey: "demo/ver_ai_002/archive.html",
        htmlSha256: "demo-ai-002",
        textSha256: "demo-ai-002-text",
        textSimhash: "demo-ai-002-sim",
        captureProfile: "complete",
        quality: createQuality(95, "high", {
          liveSignals: {
            textLength: 22500,
            imageCount: 12,
            iframeCount: 0,
        ...
        createdAt: "2026-03-20T09:18:00.000Z",
        archiveAvailable: true,
        readerArchiveAvailable: true,
        readerHtmlObjectKey: "demo/ver_ai_002/reader.html",
        archiveSizeBytes: 1592100,
        readerArchiveSizeBytes: 1184200,
      },
      {
        id: "ver_ai_001",
        bookmarkId: "bm_ai_005",
        versionNo: 1,
        htmlObjectKey: "demo/ver_ai_001/archive.html",
        htmlSha256: "demo-ai-001",
        textSha256: "demo-ai-001-text",
        textSimhash: "demo-ai-001-sim",
        captureProfile: "standard",
        quality: createQuality(89, "high"),
        createdAt: "2026-03-19T08:48:00.000Z",
        archiveAvailable: true,
        readerArchiveAvailable: false,
        archiveSizeBytes: 1218700,
      },
    ],
    bm_guide_001: [
      {
    ...
    bm_reader_006: [
      {
        id: "ver_reader_001",
        bookmarkId: "bm_reader_006",
        versionNo: 1,
        htmlObjectKey: "demo/ver_reader_001/archive.html",
        readerHtmlObjectKey: "demo/ver_reader_001/reader.html",
        htmlSha256: "demo-reader-001",
        textSha256: "demo-reader-001-text",
        textSimhash: "demo-reader-001-sim",
        captureProfile: "dynamic",
        quality: qualityReaderOnly,
        createdAt: "2026-03-20T06:42:00.000Z",
        archiveAvailable: false,
        readerArchiveAvailable: true,
        archiveSizeBytes: 0,
        readerArchiveSizeBytes: 411200,
      },
    ],
    bm_queue_007: [],
    bm_incident_008: [
      {
        id: "ver_incident_001",
        bookmarkId: "bm_incident_008",
        versionNo: 1,
        htmlObjectKey: "demo/ver_incident_001/archive.html",
        htmlSha256: "demo-incident-001",
        textSha256: "demo-incident-001-text",
        textSimhash: "demo-incident-001-sim",
        captureProfile: "complete",
        quality: qualityIncident,
        createdAt: "2026-03-20T03:16:00.000Z",
        archiveAvailable: true,
        readerArchiveAvailable: false,
        archiveSizeBytes: 388200,
      },
    ],
  };

  const archiveHtmlByVersionId: Record<string, string> = {
    ver_ai_002: buildArchiveHtml(
      "OpenAI Responses API 文本生成指南",
      "https://platform.openai.com/docs/guides/text",
      "覆盖结构化输出、工具调用与长上下文提示编排，适合测试长标题和多标签文档型书签。",
      "#0f766e",
    ),
    ver_ai_001: buildArchiveHtml(
      "OpenAI Responses API 文本生成指南 · v1",
      "https://platform.openai.com/docs/guides/text",
      "首版文档归档，正文和代码块都已保留，但信息组织还不够紧凑。",
      "#115e59",
    ),
    ...
    ver_reader_001: buildArchiveHtml(
      "GOV.UK Design System Accordion",
      "https://design-system.service.gov.uk/components/accordion/",
      "这个版本只保留阅读视图，用来测试预览模式自动回退和按钮禁用状态。",
      "#8b5cf6",
    ),
    ver_incident_001: buildArchiveHtml(
      "CDN 超时事故复盘",
      "https://status.example.net/incidents/cdn-timeout-2026-03-18",
      "事故记录里保留了主要时间线，但第三方图表和部分截图资源已经缺失。",
      "#b45309",
    ),
  };
