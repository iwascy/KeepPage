...
const configSchema = z.object({
  ...
  BACKUP_R2_ENABLED: booleanFlagSchema,
  BACKUP_R2_PREFIX: z.string().trim().default("keeppage-backups/bookmarks"),
  BACKUP_R2_TIME: z.string().regex(/^\d{2}:\d{2}$/).default("03:30"),
  BACKUP_R2_RUN_ON_STARTUP: booleanFlagSchema,
